...
export default function FloatingBar({ cart, onClick }: Props) {
  ...
  return (
    <button onClick={onClick}
      className="fixed bottom-5 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 pl-4 pr-5 py-3 rounded-2xl text-white font-bold text-[14px] transition-all hover:-translate-y-0.5 animate-pop"
